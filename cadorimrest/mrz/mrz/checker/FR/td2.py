...
import cadorimrest.mrz.mrz.base.string_checkers as check
...
class TD2CodeChecker(_TD2HashChecker, _FieldsChecker):
    ...
    def __init__(self, mrz_code: str, check_expiry=False, compute_warnings=False):
        ...
        self._identifier = lines[0][5: 11]#lines[1][14: 23]
        self._document_number = lines[0][30: 36]
        self._document_number_hash = lines[1][9]
        self._nationality = lines[0][2: 5]
        self._birth_date = lines[1][27: 33]
        self._birth_date_hash = lines[1][19]
        self._sex = lines[1][34]
        self._expiry_date = lines[1][21: 27]
        self._expiry_date_hash = lines[1][27]
        self._optional_data = lines[1][0: 12]
        self._final_hash = lines[1][14: 22]
